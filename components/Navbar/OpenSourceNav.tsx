            ...
            <div className={`relative lg:absolute -ml-5 bg-white rounded-md lg:py-4 p-6 w-[320px] transition ease-in duration-150 ${show ? "opacity-100 visible" : "opacity-0 hidden"}`}>
                ...
                <div className='mb-4 pb-0 pt-2 w-full'>
                    ...
                    <ul className='text-sm text-neutral-500 mt-1 w-full'>
                        <li >
                            <a href="/login/index.html" className='block py-2 hover:text-blue-600'>Features</a>
                        </li>
                        <li >
                            <a href="/login/index.html" className='block py-2 hover:text-blue-600'>Workflows</a>
                        </li>
                        <li >
                            <a href="/login/index.html" className='block py-2 hover:text-blue-600'>Resources</a>
                        </li>
                    </ul>
                </div>
            </div>
